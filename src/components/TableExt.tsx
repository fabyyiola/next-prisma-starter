...
export default function TableExt({
   ...
   */
  const sortRows = (config: { key: string, direction: 'ascending' | 'descending' }) => {
    const sortedRows = [...filteredRows].sort((a, b) => {
      let aValue = a.cells[tableHead.indexOf(config.key)].value.toLowerCase()
      let bValue = b.cells[tableHead.indexOf(config.key)].value.toLowerCase()
